    ...
    return (
        <div>
            <motion.div 
                ...
                className="flex bg-green-800/50 mx-5 w-[90%] md:w-[97%] mt-5 
                absolute top-0 right-0 justify-between items-center"
            >
                <motion.p 
                    initial={{ x: -200 }} 
                    animate={{ x: 0 }} 
                    transition={{ delay: 1, type: 'spring' }}
                    className='py-4 px-4 text-[#ffeaee] text-lg ml-2'
                >
                    Portfolio
                </motion.p>
                ...
                >
                    <motion.li 
                        ...
                        className="text-[#ffeaee] cursor-pointer font-light 
                        hover:font-normal hover:border-b hover:border-white"
                    >
                        Projects
                    </motion.li>
                    <motion.li 
                ...
                {view && <div className='bg-green-600/50 mt-56 absolute rounded right-1 flex justify-center'>
                    <ul className="flex flex-col gap-4 py-4 items-center px-4 md:hidden">
                        ...
                        <motion.li 
                            onClick={goToSkills} 
                            whileHover={{ y: -10, rotate: -10 }} 
                            className="text-[#ffeaee] cursor-pointer hover:font-normal 
